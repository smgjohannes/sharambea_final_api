...
function start(_App, port) {
  ...
  // CORS configuration
  const corsOptions = {
    origin: ['https://admin.sharambeaprop.com','https://sharambeaprop.com','https://files.sharambeaprop.com','http://localhost:3000','http://localhost:3001'], // Add your frontend origin here
